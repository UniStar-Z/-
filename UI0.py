...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.create_widgets()
        self.images = []
        self.users_file = "users.txt"  # 用户信息存储文件
        self.load_users()  # 加载用户信息
    ...
    def create_widgets(self):
        ...
        buttons = [
            ...
            ("用户注册", self.user_register),  # 新增注册按钮
    ...
    def user_register(self):
        ...
        # 确认密码输入
        ttk.Label(form_frame, text="确认密码:").grid(row=2, column=0, padx=10, pady=15)
        confirm_password_entry = ttk.Entry(form_frame, width=20, show="*")
        confirm_password_entry.grid(row=2, column=1, padx=10, pady=15)

        # 注册按钮
        btn_frame = ttk.Frame(register_win)
        btn_frame.pack(pady=20)
        ...
        ttk.Button(btn_frame, text="注册", command=attempt_register).pack(side=tk.LEFT, padx=15)
